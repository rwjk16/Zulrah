...
class UpdateLocation(script: com.snow.zulrah.Script) : Leaf<com.snow.zulrah.Script>(script, "Checking for location update") {
    ...
    override fun execute() {
        ...
        val revive = Condition.wait({ !isPyromancerDead(WintertodtLocation.SOUTH_WEST) || Combat.health() < hp}, 1500, 2)
